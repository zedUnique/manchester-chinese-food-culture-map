const FOOD_MAP_DATA = {
  ...
  cuisineCategories: [
    ...
    { id: "malatang", label: "Malatang / 麻辣烫", provinceIds: ["dongbei", "chuanyu"], color: "#a8424d" },
    { id: "hotpot", label: "Hotpot / 火锅", provinceIds: ["chuanyu"], color: "#c93f31" },
    { id: "family", label: "Family Memory / 家族记忆", provinceIds: ["hongkong", "guangdong"], color: "#366fae" },
    { id: "noodles", label: "Noodles & Rice / 米面主食", provinceIds: ["yunnan", "beijing", "shaanxi"], color: "#6f7f45" }
  ],
  provinces: [
    {
      id: "xinjiang",
  ...
  restaurants: [
    ...
    },
    {
      ...
      accent: "#b73352",
      cuisineCategoryIds: ["hotpot", "noodles"],
    ...
    },
    {
      ...
      accent: "#1f9a87",
      cuisineCategoryIds: ["cantonese", "family"],
    ...
    },
    {
      ...
      accent: "#1f9a87",
      cuisineCategoryIds: ["cantonese", "family", "beijing"],
    ...
    },
    {
      ...
      accent: "#d94b35",
      cuisineCategoryIds: ["chuanyu", "noodles"],
    ...
    },
    {
      ...
      accent: "#2f6fba",
      cuisineCategoryIds: ["cantonese", "hunan", "family"],
    ...
    },
    {
      ...
      accent: "#b73352",
      cuisineCategoryIds: ["malatang", "dongbei", "hotpot"],
    ...
    },
    {
      ...
      accent: "#d94b35",
      cuisineCategoryIds: ["chuanyu", "hotpot"],
    ...
    },
    {
      ...
      accent: "#2f6fba",
      cuisineCategoryIds: ["cantonese", "family", "hotpot"],
    ...
    },
    {
      ...
      accent: "#b73352",
      cuisineCategoryIds: ["cantonese", "hotpot"],
